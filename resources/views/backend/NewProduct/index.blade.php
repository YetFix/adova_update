                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{route('npro.view',$product->id)}}">View</a>
                                        <a class="btn btn-primary" href="{{route('npro.edit',$product->id)}}">Edit</a>
                                        <a class="btn btn-danger"
                                            href="{{route('npro.down',$product->id)}}">Download</a>
                                        <a class="btn btn-danger" href="{{route('npro.del',$product->id)}}">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
