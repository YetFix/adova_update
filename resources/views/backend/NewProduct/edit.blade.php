    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <a href='/newproducts' class="btn btn-primary">Back</a>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="#" class="fw-normal">Dasboard > Upcoming Product > Edit</a></li>
                    </ol>
                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            @endif
                            <form action="{{route('npro.update',$product->id)}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="category"
                                                ...
                                                placeholder="Enter category name" value="{{$product->category}}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Overdoge</label><br>

                                            <textarea name="overdoge" id="overdoge" cols="30" rows="4"></textarea>
                                        </div>
                                        <div class="form-group">
